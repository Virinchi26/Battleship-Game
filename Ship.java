...
public class Ship {
    ...
    // Draws the ship with color if it is valid then green else red
    ...
    //  vertical ship by first drawing a triangle for the first cell, and then a rectangle to cover the remaining cells based on the number of segments.
    ...
    //  horizontal ship by first drawing a triangle for the first cell, and then a rectangle to cover the remaining cells based on the number of segments.

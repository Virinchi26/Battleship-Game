...
public class SelectionGrid extends Rectangle {
    ...
    // Draws the ships if all ships on this grid are to be shown
    ...
    //Changes the state of the grid to show all the ships if set to true
    ...
    // Marks the specified position and then check the ships
...
// translate position 
    ...
    //The ships will not be placed over the top of other ships
...
//Places a ship on the grid with the specified properties
